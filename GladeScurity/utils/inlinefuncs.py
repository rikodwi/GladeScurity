...
from GladeScurity import pbot as app
from GladeScurity import arq
from GladeScurity.services.keyboard import Ikb
from GladeScurity.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from GladeScurity.services.tasks import _get_tasks_text, all_tasks, rm_task
from GladeScurity.services.types import InlineQueryResultCachedDocument
from GladeScurity.modules.info import get_chat_info, get_user_info
from GladeScurity.modules.music import download_youtube_audio
from GladeScurity.utils.functions import test_speedtest
from GladeScurity.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/GladeScurityBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Glade Scurity](https://t.me/GladeScurityBot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
