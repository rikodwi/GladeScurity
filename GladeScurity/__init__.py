...
def get_user_list(__init__, key):
    with open("{}/GladeScurity/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[GladeScurity] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[GladeScurity]')
LOGGER.info("Glade is starting. | An Glade scurity Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: (t.me/KUMiSCooLLL")
...
if ENV:
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Glade scurity")
    ...
    from GladeScurity.config import Development as Config
...
try:
    from GladeScurity.antispam import antispam_restrict_user, antispam_cek_user, detect_user
...
from GladeScurity.modules.helper_funcs.handlers import (
