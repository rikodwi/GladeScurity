...
import GladeScurity.modules.sql.notes_sql as sql
from GladeScurity import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from GladeScurity.__main__ import DATA_IMPORT
from GladeScurity.modules.helper_funcs.chat_status import user_admin
from GladeScurity.modules.helper_funcs.alternate import typing_action

# from GladeScurity.modules.rules import get_rules
import GladeScurity.modules.sql.rules_sql as rulessql

# from GladeScurity.modules.sql import warns_sql as warnssql
import GladeScurity.modules.sql.blacklist_sql as blacklistsql
from GladeScurity.modules.sql import disable_sql as disabledsql

# from GladeScurity.modules.sql import cust_filters_sql as filtersql
# import GladeScurity.modules.sql.welcome_sql as welcsql
import GladeScurity.modules.sql.locks_sql as locksql
from GladeScurity.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Glade Scurity{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Glade Scurity{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Glade Scurity-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Glade Scurity{}.backup".format(chat_id))  # Cleaning file
