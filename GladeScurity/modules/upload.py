...
from GladeScurity import telethn as bot
from GladeScurity.modules.urluploader import download_file
from GladeScurity.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @GladeScurityBot",
            )
        except Exception as e:
            traceback.print_exc()
