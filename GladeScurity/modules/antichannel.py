...
from GladeScurity.modules.helper_funcs.decorators import Gladecmd, Glademsg
from GladeScurity.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from GladeScurity.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@Gladecmd(command="antich", group=100)
...
@Glademsg(Filters.chat_type.groups, group=110)
